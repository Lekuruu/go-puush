...
// ColorLogger is the default human-readable slog handler used by puush.
...
func (h *ColorLogger) Handle(_ context.Context, record slog.Record) error {
	...
	// If no "component" attribute is found, use the application component.
	if component == "" {
