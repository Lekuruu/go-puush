// NOTE: This is a custom version of the gallery.js file that supports audio & video embeds.
//       It has to be explicitly enabled inside the config file.
(function(w) {
  w.galleries = {
    items: {},
    item_count: 0,
    ...
    redrawSelected: function() {
      ...
      if (galleries.isAudio(galleries.selected)) {
        parent.append(
